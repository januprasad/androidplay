 ...
 */
public class NotesFragment extends Fragment implements NotesViewModel.Observer {
    ...
    private void loadContent() {
        ...
        notesViewModel.init();
        notesViewModel.notes.observe(this, new Observer<Content>() {
            @Override
    ...
    private void uiThings(Content content) {
    ...
    public static NotesFragment makeOneInstance() {
